 ...
 * <p>Source      		: AuthenticationController </p>
 * <p>Package     		: com.api.authentication.controller</p>
 * 
...
import com.api.authentication.service.AuthenticationServiceImpl;
 ...
 *
 * @param authenticationServiceImpl the authentication service impl
 */
@AllArgsConstructor
...
public class AuthenticationController {
	...
	/**
	 * Logger object is initialized for AuthenticationController class.
	 */
	...
	public ResponseEntity<SignedResponse> initiateAndValidateLoginTransaction(
		...
		ResponseEntity<SignedResponse> htResponseEntity = authenticationServiceImpl.validateJwtAndProcessLoginRequest(headersMap,
				loginObj);
	...
	public ResponseEntity<SignedResponse> initiateAndValidateLogoutTransaction(
		...
		ResponseEntity<SignedResponse> htResponseEntity = authenticationServiceImpl.validateJwtAndProcessLogoutRequest(headersMap,
				logoutObj);
		LOGGER.info("Response -->> {}", htResponseEntity);
	...
	public @ResponseBody List<UserEntity> allUsersDetails() throws IOException {
		LOGGER.info("<<<<<<<<<<<<<<< AllUsersDetails User Functionality Started <<<<<<<<<<<<");
			...
			return authenticationServiceImpl.ListofUsers();
	...
	public @ResponseBody List<UserEntity> allUsersOngoingDetails() throws IOException {
		LOGGER.info("<<<<<<<<<<<<<<< AllUsersDetails User Functionality Started <<<<<<<<<<<<");
			...
			return authenticationServiceImpl.ListofOngoingUsers();
	...
	public @ResponseBody List<UserEntity> allUsersCompletedDetails() throws IOException {
		LOGGER.info("<<<<<<<<<<<<<<< AllUsersDetails User Functionality Started <<<<<<<<<<<<");
			...
			return authenticationServiceImpl.ListofcompletedUsers();
	...
	public @ResponseBody List<UserEntity> allUsersHistoricalDetails(@RequestParam String historical) throws IOException {
		LOGGER.info("<<<<<<<<<<<<<<< AllUsersDetails User Functionality Started <<<<<<<<<<<<");
			...
			return authenticationServiceImpl.ListofHistoricalUsers(historical);
